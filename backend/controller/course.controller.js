...
const createCourse = async(req,res,next)=>{
    ...
    if(req.file){
        ...
        try{
            ...
            return next(new AppError(JSON.stringify(error) || 'File not uploaded, please try again',
            400));
        }
...
export {getAllCourses,getLecturesByCourseId,createCourse,removeLectureFromCourse,addLectureToCourseById,updateCourseById,deleteCourseById};