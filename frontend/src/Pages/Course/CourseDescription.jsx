...
function CourseDescription(){
    ...
    return (
        <Layout>
            ...
            <div className="min-h-[90vh] pt-12 px-5 md:px-10 flex flex-col items-center justify-center text-white  ">
                {/* displaying the course details */}
                <div className="  grid grid-cols-2 gap-5 md:gap-10 py-10 ">
                {/* creating the left side of description box */}
                    <div className="space-y-5">
                        ...
                        <div className="space-y-4">
                            ...
                            {(role === "ADMIN") || (data?.subscription === "active") ? (
                                ...
                                className="bg-yellow-600 text-xl rounded-md font-bold px-5 py-3 w-fit md:w-full hover:bg-yellow-500 transition-all ease-in-out duration-300"
                                >
                                Subscribe to Course
                                </button>
                            )}
                    ...
                    <div className="space-y-2 text-xl">
                        <h1 className="text-xl md:text-3xl font-bold text-orange-500 text-center mb-4">
                        {state.title}
                        </h1>
