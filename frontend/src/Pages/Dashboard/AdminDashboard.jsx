...
const AdminDashboard = () => {
  ...
  const { allRegisteredUsers, subscribedUsersCount } = useSelector(
    (state) => state.payment
  );
  ...
  const userData = {
    ...
    datasets: [
      {
        label: "User Details",
        data: [allRegisteredUsers, subscribedUsersCount],
  ...
  const myCourses = useSelector((state) => state.courses.coursesData);
  ...
  return (
    <Layout>
      <div className="min-h-[90vh] w-full pt-5 flex flex-col text-white">
        ...
        <div className=" w-full grid grid-cols-2 gap-5 m-auto ">
          ...
          <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md shadow-md">
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-4xl font-bold">{allRegisteredUsers}</h3>
                </div>
           ...
           {/* card for enrolled users */}
           <div className=" flex items-center justify-center py-5  gap-1 rounded-md shadow-md w-full">
                <div className="w-full flex text-4xl font-bold flex-col items-center ">
                  <p className="font-semibold text-orange-400">Total Revenue</p>
                  <div className="text-4xl font-bold flex items-center justify-center">
                    <BiRupee /><span>{subscribedUsersCount * 1999}</span><GiMoneyStack className="text-green-500 text-5xl" />
                  </div>
                </div>
        ...
        <div className=" w-[100%] self-center flex flex-col items-center justify-center  mb-10">
              ...
              {myCourses?.map((element, index) => {
                return (
                  <tr key={element?._id}>
                    ...
                    <td className="max-w-40  text-ellipsis whitespace-nowrap">
                      <textarea
                        readOnly
                        className="overflow-hidden h-auto bg-transparent resize-none "
